...
namespace AirSimUnity {
    ...
    public class CameraFiltersScript : MonoBehaviour {
        ...
        private void SetDepthEffect() {
            myCamera.renderingPath = RenderingPath.Forward;
            SetupCameraWithReplacementShader(2, Color.black);
        }
        private void SetDepthNormalsEffect()
        {
            myCamera.renderingPath = RenderingPath.Forward;
            SetupCameraWithReplacementShader(3, Color.black);
        }
        private void SetNormalsEffect()
        {
            myCamera.renderingPath = RenderingPath.Forward;
            SetupCameraWithReplacementShader(4, Color.black);
        }
